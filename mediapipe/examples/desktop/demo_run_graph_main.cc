...
absl::Status RunMPPGraph() {
  ...
  while (grab_frames) {
    ...
    std::cout << test[0].landmark(1).z() << std::endl;
    // // std::cout << graph << std::endl;
    // // std::cout << packet.Get<mediapipe::NormalizedLandmarkList>() << std::endl;
    // // std::cout << graph.Options<mediapipe::LandmarksToRenderDataCalculatorOptions>();
